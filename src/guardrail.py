...
# ---------------------------------------------------------------------------
# Maximum allowed length per control-area description (characters)
# ---------------------------------------------------------------------------
...
INJECTION_PATTERNS: list[str] = [
    ...
    # Injection delimiters / format tricks
...
def detect_prompt_injection(text: str) -> str | None:
    ...
    # Look for suspiciously long base64-encoded strings (≥60 chars)
